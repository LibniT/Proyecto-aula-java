...
public class Prestamos extends javax.swing.JPanel {
    ...
    private void prestar_libro() {
        try {
            ...
            if (libro.prestar(idLibro, nombreUsuario)) {
                JOptionPane.showMessageDialog(this, "El libro se prestó exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                // Limpiar los campos después de un préstamo exitoso
                TxtIdLibro.setText("");
                TxtUsuario.setText("");
            } else {
                JOptionPane.showMessageDialog(this, "No se pudo prestar el libro. Verifique los datos.", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void initComponents() {
        ...
        btnPedir.setBackground(new java.awt.Color(204, 0, 0));
    ...
    private void btnPedirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPedirMouseClicked
        prestar_libro();
    }//GEN-LAST:event_btnPedirMouseClicked
