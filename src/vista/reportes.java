...
public class reportes extends javax.swing.JPanel {
    ...
    private void cargarReportes() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("reportes.txt"))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] data = line.split(",");
                if (data.length == 4) {
                    model.addRow(new Object[]{
                        data[0], // ID PERSONA (nombre de usuario)
                        data[1], // ID LIBRO
                        data[2], // FECHA DE SALIDA
                        data[3].isEmpty() ? "No devuelto" : data[3] // FECHA DE ENTREGA
                    });
                }
            }
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        TBLREPORTES.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PERSONA", "ID LIBRO ", "FECH DE SALIDA", "FECHA DE ENTREGA"
            }
        ) {
